  ...
  return (
    <SpaceX className="flex flex-col gap-[3rem] xl:gap-[6rem] w-full">
      ...
      <div className="flex flex-col-reverse xl:flex-row items-center xl:justify-between gap-[2rem]">
        ...
        <div className="relative overflow-hidden shadow-s1 dark:shadow-none rounded-full dark:rounded-none border border-soft-white/50 dark:border-none">
          <CustomImage
            src={personalImage}
            priority={true}
            alt="Personal image"
