      ...
      >
        ...
        <article
          className={clsx(
            ...
            "border border-black/20 dark:border-soft-gray/20 p-[1.5rem] xl:p-[2rem] rounded-[3rem] bg-white-bone-md dark:bg-black shadow-s2 dark:shadow-s1 flex flex-col justify-between  group-hover:dark:border-soft-gray group-hover:border-black/20 theme-transition-all",
          )}
        >
          <div>
