...
const GithubButton = () => {
  return (
    ...
    >
      <div className="[&_svg]:fill-soft-white border rounded-full border-soft-gray w-[3rem] h-[3rem] xl:w-[3.5rem] xl:h-[3.5rem] flex justify-center items-center group-hover:bg-soft-white group-hover:border-soft-white group-hover:[&_svg]:fill-black transition-all duration-400 ease-in-out">
