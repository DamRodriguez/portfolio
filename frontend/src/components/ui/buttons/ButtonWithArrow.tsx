...
const ButtonWithArrow = (props: ButtonWithArrowProps) => {
  return (
    ...
    >
      <div
        className={clsx(
          "backdrop-blur[0.1rem] py-[0.5rem] xl:py-[1rem] flex items-center rounded-full italic font-medium border shadow-s3 theme-transition",
          ...
          {
            "h-[1.7rem] xl:h-[2.5rem] px-[2rem] text-xs xl:text-base":
              props.small,
            "h-[2.5rem] lg:h-[3rem] px-[3rem] xl:px-[4rem] 2xl:px-[5rem] 4xl:px-[7rem] text-base xl:text-xl":
              !props.small,
          },
        )}
      >
      ...
      <div
        className={clsx(
          "rounded-full bg-black dark:bg-soft-white flex items-center justify-center group-hover:rotate-180 theme-transition-all shadow-s3",
          {
      ...
      >
        <ArrowIcon
          className={clsx("", {
            "w-[1.3rem] h-[1.3rem] xl:w-[1.5rem] xl:h-[1.5rem] fill-soft-white dark:fill-black":
              props.small,
            "w-[1.5rem] h-[1.5rem] lg:w-[2rem] lg:h-[2rem] fill-soft-white dark:fill-black":
              !props.small,
          })}
        />
      </div>
