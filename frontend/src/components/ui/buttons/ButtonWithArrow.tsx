...
const ButtonWithArrow = (props: ButtonWithArrowProps) => {
  return (
    <Button
      ...
      <div className={clsx("bg-soft-white backdrop-blur-[0.1rem] py-[0.5rem] xl:py-[1rem] flex items-center rounded-full italic font-medium group-hover:bg-transparent group-hover:text-soft-white border-soft-white group-hover:border-soft-gray/80 border transition-all duration-400 shadow-s3",
        {
      ...
      <div className={clsx("rounded-full bg-soft-white flex items-center justify-center group-hover:rotate-180 transition-all duration-400 shadow-s3",
        {
