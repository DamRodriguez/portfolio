...
const ProjectItem = (props: ProjectItemProps) => {
  ...
  return (
    <div
      ...
      className={clsx(
        "w-full min-h-[calc(100dvh-var(--height-header-mobile))] xl:min-h-[calc(100dvh-var(--height-header-desktop))] flex justify-end flex-col-reverse items-start xl:items-center xl:flex-row gap-[1.5rem] xl:gap-[5rem] scroll-mt-[5rem] xl:scroll-mt-[3rem]",
        {
